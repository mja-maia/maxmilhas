...
class ListInbound extends Component {
  render() {
    const { flightList } = this.props
    return <div>
      {isEmpty(flightList) ? <ReactLoading className="loader" color="#1abc9c" type="spin" height={"5%"} width={"5%"} /> : flightList.inbound.map(
        (flight, index) => (
          <div key={index}>
                    ...
                    <div className="cia-price">
                      ...
                      <div className="highlight-price">
                        <div className="price">
                          ...
                          <div className="small">
                            Volta por adulto com taxas na MaxMilhas{" "}
                          </div>

                          <div className="value-total-maxmilhas">
                            {`Valor total do voo de volta R$ ${
